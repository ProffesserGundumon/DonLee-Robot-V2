...
GROUP_LINK = os.environ.get("GROUP_LINK", "t.me/joinchat/ZLDkX7o8pWthZTE1")
CHANNEL_LINK = os.environ.get("CHANNEL_LINK", "t.me/FilmHouse_2")
FORCE_SUB_TEXT = os.environ.get("FORCE_TEXT", Translation.FSUB_TEXT)
name_button_welcome = "📢Join  Updates Channel📢"
